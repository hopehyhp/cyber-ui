  ...
  <div class="button-demo container">
    <div class="card">
      ...
      <p class="kv">
        基于项目内的
        <code>CButton</code>
        封装的按钮组件，支持三种样式（primary / secondary / ghost），三种尺寸（small / medium /
        large），以及 loading 和 disabled 状态。
      </p>
        ...
        <div class="interactive-layout">
          <aside class="interactive-controls">
            <div class="control-group">
              ...
              <div class="option-group">
                <label class="option-chip">
                  <input v-model="type" type="radio" value="primary" />
                  <span>Primary</span>
                </label>
                <label class="option-chip">
                  <input v-model="type" type="radio" value="secondary" />
                  <span>Secondary</span>
                </label>
                <label class="option-chip">
                  <input v-model="type" type="radio" value="ghost" />
                  <span>Ghost</span>
                </label>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="option-group">
                <label class="option-chip">
                  <input v-model="size" type="radio" value="small" />
                  <span>Small</span>
                </label>
                <label class="option-chip">
                  <input v-model="size" type="radio" value="medium" />
                  <span>Medium</span>
                </label>
                <label class="option-chip">
                  <input v-model="size" type="radio" value="large" />
                  <span>Large</span>
                </label>
              </div>
            </div>
    ...
    <div class="card">
      ...
      <table class="api-table bordered">
        ...
        <tbody>
          <tr>
            <td>type</td>
            <td>按钮类型：primary / secondary / ghost</td>
            <td>String</td>
            <td>primary</td>
          </tr>
          <tr>
            <td>size</td>
            <td>按钮尺寸：small / medium / large</td>
            <td>String</td>
            <td>medium</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>loading</td>
            <td>加载状态，显示 spinner 且触发点击被禁用</td>
            <td>Boolean</td>
            <td>false</td>
          </tr>
          <tr>
            <td>plain</td>
            <td>朴素样式（类 outline）</td>
            <td>Boolean</td>
            <td>false</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>icon</td>
            <td>内置图标名称，如 settings / search / plus</td>
            <td>String</td>
            <td>—</td>
          </tr>
          <tr>
